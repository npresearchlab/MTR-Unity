...
public class SerialController : MonoBehaviour
{
    ...
    public ArduinoHandler messageListener;
    ...
    //Whether the serial connector has connected or not.
    public bool isConnected {
        get
        {
            return serialThread.isConnected;
        }
    }
    ...
    void OnEnable()
    {
        ...
        //Set the controller for the Arduino handler.
        if (messageListener != null)
            messageListener.SetController(this);
    }
    ...
    void Update()
    {
        ...
        //Null check for when there are no current messages.
        if (message == null)
            return;
        ...
        else if (ReferenceEquals(message, SERIAL_DEVICE_DISCONNECTED))
        {
            ...
            messageListener.SendMessage("OnMessageArrivedStr", message);
    }
